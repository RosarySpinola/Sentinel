...
import { DEMO_PROVER_RESULT, DEFAULT_CODE } from "./constants";
...
export default function ProverPage() {
  ...
  const { result, isLoading, error, runProver, loadDemo, clear } = useProver();
    ...
    <div className="flex h-[calc(100vh-4rem)] flex-col">
      ...
      <div className="flex items-center justify-between border-b p-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button variant="secondary" onClick={handleLoadDemo} disabled={isLoading}>
